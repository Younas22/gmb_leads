        ...
        <main class="flex-1 px-4 sm:px-8 py-10 sm:py-16">
            <div class="max-w-4xl mx-auto card-animate">
                ...
                <div class="text-center mb-10 sm:mb-14">
                    <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-primary-orange to-orange-600 rounded-2xl shadow-xl shadow-orange-200/50 mb-5">
                        <i class="fas fa-file-contract text-white text-2xl"></i>
                    </div>
                    <h1 class="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight mb-3">Terms of Service</h1>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-gray-200/50 overflow-hidden">
                    ...
                    <div class="p-6 sm:p-10 lg:p-12 policy-content">
                        ...
                        <h3><span class="num">3</span> Accounts</h3>
                        ...
                        <h3><span class="num">4</span> Acceptable Use</h3>
                        <p>You agree not to:</p>
                        <ul>
                            <li>Use the service for illegal or abusive purposes</li>
                            <li>Attempt to resell, redistribute, or scrape data outside the platform</li>
                            <li>Violate any applicable local or international laws</li>
                        </ul>
                        <p>We reserve the right to suspend or terminate accounts that violate these terms.</p>

                        <h3><span class="num">5</span> Data & Accuracy</h3>
                        <p>CustomerNearme provides business data sourced from publicly available platforms. We do not guarantee absolute accuracy or completeness and are not responsible for business outcomes resulting from the use of the data.</p>

                        <h3><span class="num">6</span> Payments & Billing</h3>
                        <p>Payments are processed by our Merchant of Record (Paddle). By purchasing a plan, you agree to Paddle's checkout and payment terms. Prices, features, and plans may change at any time.</p>

                        <h3><span class="num">7</span> Subscription & Cancellation</h3>
                        <p>Subscriptions can be canceled at any time from your dashboard. Cancellation stops future billing but does not retroactively refund past payments unless stated otherwise.</p>

                        <h3><span class="num">8</span> Limitation of Liability</h3>
                        <p>CustomerNearme shall not be liable for any indirect, incidental, or consequential damages arising from the use of our service.</p>

                        <h3><span class="num">9</span> Modifications</h3>
                        <p>We may update these Terms from time to time. Continued use of the service constitutes acceptance of the updated terms.</p>

                        <h3><span class="num">10</span> Contact</h3>
                        <p>For questions regarding these Terms, contact us at:</p>
                        <div class="flex items-center gap-3 p-4 bg-orange-50 border border-orange-100 rounded-xl">
